...
Edge computing has emerged as a critical architectural shift aimed at bringing computation and intelligence closer to data sources, especially in environments where latency, bandwidth constraints, and real-time processing requirements dominate system design. The topic was selected because modern distributed infrastructures—from IoT deployments to autonomous services—demand architectures capable of delivering efficiency, resilience, and robust security at the network edge. Throughout this work, we analyze the essential components that define edge computing, including architectural layers, communication models, security threats, and the mechanisms used to mitigate them. Each aspect is examined from both conceptual foundations and contemporary research developments.

The research team organized the work into coordinated sections to provide a structured and comprehensive study. The roles of each member are summarized as follows:

\begin{itemize}
    \item \textbf{Djebouri Linda}: Introduced the general context, outlined key security threats, and contributed to the preparation and design of the presentation.
    \item \textbf{Khedri Manal}: Examined the architecture of edge computing, including edge devices, edge servers, and cloud server layers.
    \item \textbf{Ait Hocine Khadidja}: Investigated DDoS attacks in edge environments and reviewed existing defense mechanisms.
    \item \textbf{Bouakkaz Madjeda}: Explored side-channel attacks and the protective techniques used to counter them.
    \item \textbf{Boutria Manal}: Analyzed malware-injection attacks targeting edge nodes.
    \item \textbf{Ferrat Ilham}: Discussed weaknesses in authentication and authorization processes.
    \item \textbf{Hammouti Walid}: Provided a comparative study between security challenges in edge systems and those found in cloud computing.
    \item \textbf{Kellakh Ranyme}: Identified the root causes underlying persistent security issues.
    \item \textbf{Ferkioui Akram}: Presented the main challenges facing current systems and contributed to the writing of the project report.
    \item \textbf{Dokkar Chaima}: Outlined future research directions supporting the evolution of secure and scalable edge architectures.
\end{itemize}

Through this collaborative effort, the group offers a unified and coherent understanding of edge computing and highlights the open problems that continue to drive research in this rapidly developing field.
...
1. Per-packet inspection and filtering: Drop suspicious packets before they reach the server (e.g., packet filters tied to congestion control). Effective but can be evaded by IP/MAC spoofing, forged headers, or tools that alter identifiers.
...
\begin{itemize}
    ...
    % --- Existing References ---
    \item \textbf{IEEE Xplore}. “Edge Computing Security: State of the Art and Challenges.”
    \item \textbf{GeeksforGeeks}. “What Is Edge Architecture?” Available at: \url{https://www.geeksforgeeks.org}.
    \item \textbf{Aerospike Blog}. Matt Bushell, “What Is Edge Computing?” Available at: \url{https://aerospike.com}.
    \item \textbf{Red Hat}. “What is edge computing?” Available at: \url{https://www.redhat.com}.

    % --- Added References ---
    \item \textbf{IBM}. “What is Edge Computing?” Available at: \url{https://www.ibm.com/think/topics/edge-computing}.
    \item \textbf{Whiteboard Security Blog}. Available at: \url{https://whiteboardsecurity.blogspot.com/?m=1}.

    % --- Side Channel Attacks & Defenses ---
    \item H. Li et al., “Side-channel information leakage of encrypted video stream in video surveillance systems.”
    \item X. Ji et al., “User presence inference via encrypted traffic of wireless camera in smart homes.”
    \item M. Li et al., “When CSI meets public WiFi: Inferring your mobile phone password via WiFi signals.”
    \item Q. A. Chen et al., “Peeking into your app without actually seeing it: UI state inference and novel Android attacks.”
    \item M. Enev et al., “Televisions, video privacy, and powerline electromagnetic interference.”
    \item G. W. Hart, “Nonintrusive appliance load monitoring.”
    \item S. S. Clark et al., “Current events: Identifying webpages by tapping the electrical outlet.”
    \item S. B. Ors et al., “Power-analysis attacks on an FPGA—first experimental results.”
    \item W. Diao et al., “New inference attacks on Android through interrupt timing analysis.”

    % --- Defense: Data Perturbation ---
    \item C. Dwork, “Differential privacy: A survey of results.”
    \item D. Kifer and A. Machanavajjhala, “No free lunch in data privacy.”

    % --- Defense: Access Control ---
    \item Q. A. Chen et al., “Peeking into your app without actually seeing it...” (UI inference attacks).
    \item Q. Xiao et al., “Mitigating storage side channels using statistical privacy mechanisms.”

    % --- Defense: Obfuscation ---
    \item D. Molnar et al., “The program counter security model: Automatic detection and removal of control-flow side channel attacks.”

    % --- Defense: Hardware Isolation ---
    \item R. Strackx and F. Piessens, “The Heisenberg defense: Proactively defending SGX enclaves against page-table-based side-channel attacks.”
    \item Y. Fu et al., “SGX-LAPD: Thwarting controlled side channel attacks via enclave verifiable page faults.”

    % --- Malware Injection References ---
    \item C. Anley, “Advanced SQL injection in SQL server applications,” 2002.
    \item W. G. J. Halfond, J. Viegas, and A. Orso, “A classification of SQL injection attacks and countermeasures,” 2006.
    \item Y.-W. Huang et al., “Securing web application code by static analysis and runtime protection,” WWW 2004.
    \item “Cisco fog director cross-site scripting vulnerability,” 2016.
    \item M. Martin and M. S. Lam, “Automatic generation of XSS and SQL injection attacks with goal-directed model checking,” 2008.
    \item S. Gupta and B. B. Gupta, “Cross-site scripting (XSS) attacks and defense mechanisms,” IJSAEM, 2017.
    \item N. Jovanovic et al., “Preventing cross site request forgery attacks,” Securecomm 2006.
    \item A. Barth et al., “Robust defenses for cross-site request forgery,” CCS 2008.
    \item A. Costin, “IoT embedded vs. security,” FRUCT 2017.
    \item M. McIntosh and P. Austel, “XML signature element wrapping attacks,” 2005.
    \item M. Jensen et al., “On the effectiveness of XML schema validation for countering XML signature wrapping attacks,” 2011.
    \item A. Cui et al., “When firmware modifications attack,” NDSS 2013.
    \item G. Hernandez and D. Buentello, “Smart Nest thermostat: A smart spy in your home,” Black Hat 2014.
    \item E. Ronen et al., “IoT goes nuclear: Creating a ZigBee chain reaction,” SP 2017.
    \item A. Greenberg, “The Reaper IoT botnet already infected a million networks,” 2017.
    \item K. Chen et al., “Cross-platform analysis of harmful libraries on Android/iOS,” SP 2016.
    \item T. Li et al., “Understanding cross-app remote infections on mobile WebViews,” CCS 2017.
    \item Y. Xiao et al., “Privilege leakage and information stealing via Android task mechanism,” PAC 2017.

    % --- DDOS / DOS References ---
    \item J. Udhayan and R. Anitha, “Demystifying and rate limiting ICMP hosted DoS/DDoS flooding attacks,” 2009.
    \item M. Bogdanoski et al., “Analysis of the SYN flood DoS attack,” IJCIS, 2013.
    \item Y.-H. Hu et al., “Packet filtering to defend flooding-based DDoS attacks,” 2004.
    \item K. Elleithy et al., “Denial of service attack techniques,” 2006.
    \item A. Yaar et al., “PI: A path identification mechanism to defend against DDoS attacks,” 2003.
    \item M. Zolotukhin et al., “Detecting application-layer DDoS attacks in encrypted traffic,” ICT 2016.

    % --- Embedded Systems / Hardware ---
    \item M. A. Mazidi et al., “Embedded Systems,” Pearson, 2008.
    \item R. Barry, “FreeRTOS Reference Manual,” 2009.
    \item B. Xiong, “RT-Thread Programming Guide 0.3.3.”
    \item M. Mazzillo et al., “Silicon photomultiplier technology,” IEEE TNS, 2009.
    \item L. Gwennap, “Qualcomm tips Cortex-A57 plans,” 2014.
    \item Y. Yu et al., “Cloud computing security and privacy: Standards and regulations,” 2017.
    \item S. Basu et al., “Cloud computing security challenges and solutions,” CCWC 2018.

    % --- Edge Architecture Resources ---
    \item GlobalLogic, “Immunizing Edge Computing.” Available at: \url{https://www.globallogic.com/.../Immunizing-Edge-Computing.pdf}.
    \item IJGIS, “Edge Architecture Research.” Available at: \url{https://ijgis.pubpub.org/pub/xyr2cz07/release/1}.

    % --- Future Research References ---
    \item E. Fernandes et al., “Security analysis of emerging smart home applications,” SP 2016.
    \item C. Livadas et al., “Using machine learning to identify botnet traffic,” LCN 2006.
    \item E. Ronen et al., “IoT goes nuclear: ZigBee chain reaction,” SP 2017.
    \item J. Chen et al., “IoTFuzzer: Discovering memory corruptions in IoT,” NDSS 2018.
    \item T. Frassetto et al., “IMIX: In-process memory isolation extension,” USENIX Security 2018.
    \item S. Shirali-Shahreza and Y. Ganjali, “SDN-based firewall for home devices,” IEEE TCE 2018.
    \item C. Dietz et al., “IoT-botnet detection and isolation by routers,” NOF 2018.
    \item M. A. Islam et al., “Thermal side channel for power attacks,” CCS 2017.
    \item S. Weiser et al., “Timber-V: Tag-isolated memory for RISC-V enclaves,” NDSS 2019.
    \item Y. Jia et al., “Graph-based mechanism for identifying smart home IoT vulnerabilities,” INFOCOM 2018.
