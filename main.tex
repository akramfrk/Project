...
The research team organized the work into coordinated sections to provide a structured and comprehensive study. Djebouri Linda introduced the general context and outlined the key security threats that motivate the need for secure edge infrastructures and contributed to the preparation and design of the presentation. Khedri Manal examined the architecture of edge computing by analyzing the edge device, edge server, and cloud server layers. Ait Hocine Khadidja investigated DDoS attacks in edge environments and reviewed existing defense mechanisms. Bouakkaz Madjeda explored side-channel attacks and the protective techniques used to counter them. Boutria Manal analyzed malware-injection attacks that target edge nodes. Ferrat Ilham discussed weaknesses in authentication and authorization processes. Hammouti Walid provided a comparative study between security challenges in edge systems and those found in cloud computing. Kellakh Ranyme identified the root causes underlying persistent security issues. Ferkioui Akram presented the main challenges facing current systems and worked on the project report. Finally, Dokkar Chaima outlined future research directions to support the evolution of secure and scalable edge architectures.
...
\begin{itemize}
    ...
    \item Conventional monitoring cannot detect actions within granted privileges .
...
\begin{itemize}
    ...
    \item \textbf{Granular authorization:} Least-privilege via dynamic RBAC/ABAC .
    \item \textbf{Real-time monitoring:} UEBA, AI-driven anomaly detection, distributed SIEM.
    \item \textbf{Zero-trust posture:} Verify all requests using mutual TLS and  workload identity.
\end{itemize}
...
\begin{itemize}
    \item IEEE Xplore: Edge Computing Security: State of the Art and Challenges
    \item Youtube:
    \begin{itemize}
        \item \href{https://youtu.be/kOSJbiWMZKo?si=_QKyPqhQ7oUHaAJc}{Video 1}
        \item \href{https://youtu.be/Abiu2YaY6b0?si=livQRpg5GOX9C_F9}{Video 2}
        \item \href{https://youtu.be/3ynEvRldygY?si=p-hYhqlGbGeK0k9C}{Video 3}
        \item \href{https://www.youtube.com/watch?v=cEOUeItHDdo}{Video 4}
        \item \href{https://youtu.be/RaAioL1Kpno}{Video 5}
    \end{itemize}
    \item What is Edge Architecture? - https://www.geeksforgeeks.org
\end{itemize}
\end{document}
